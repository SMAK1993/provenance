...
public class App extends BasicApp {
    ...
    public void start() {
...

        {
            ...
            EndpointWorker workers = new EndpointWorker(new RestTemplate(), articleDataGateway);
            WorkScheduler<EndpointTask> scheduler = new WorkScheduler<>(finder, Collections.singletonList(workers), 300);
            scheduler.start();
        }
    }
